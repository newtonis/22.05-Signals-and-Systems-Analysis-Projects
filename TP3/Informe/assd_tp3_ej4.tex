...
En la simulación para la decimación se utilizó la función fir1 de matlab para obtener los coeficientes del filtro.
Donde:\\
fs = 512KHz\\
fc = 38.4KHz\\
wn = fc/(fs/2) = 0.15 \\
Y arbitrariamente se elegió para la ventana de hamming N = 31.
